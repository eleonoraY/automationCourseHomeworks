...
public class Person {
    ...
    public Person(String EGN, String sex, String name, String religion, String languageSpoken, String nationality, String countryOfresidence){
        validateEGN(EGN);
        this.EGN=EGN;
        this.name=name;
        validateSex(sex);
    ...
    public void printAdult(int age){
        if(this.age>=age){
